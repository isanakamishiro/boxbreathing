...
public class KizunaPresenter extends Presenter<KizunaPresenter.MyView, KizunaPresenter.MyProxy> {
    ...
    @ProxyStandard
    @NameToken(NameTokens.KIZUNA)
    interface MyProxy extends ProxyPlace<KizunaPresenter> {
    }
